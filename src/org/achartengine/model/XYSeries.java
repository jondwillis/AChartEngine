...
public class XYSeries implements Serializable {
  ...
  /** A list to contain the values for the X and Y axes. */
  private List<PointD> mXY = new ArrayList<PointD>();
  ...
  public synchronized void remove(int index) {
    PointD removed = mXY.remove(index);
    if (removed.x == mMinX || removed.x == mMaxX || removed.y == mMinY || removed.y == mMaxY) {
      initRange();
    }
  }
  ...
  public List<PointD> getXY() {
    return mXY;
  }

  public void setXY(List<PointD> mXY) {
    this.mXY = mXY;
  }
